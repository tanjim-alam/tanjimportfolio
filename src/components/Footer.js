    ...
    >
      <div className="max-w-6xl mx-auto px-8 md:px-16 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <span className="text-base font-bold tracking-widest" style={{ fontFamily: 'var(--font-display)', color: '#3b82f6' }}>
            TANJIM
          </span>
          <span className="text-white text-sm hidden md:inline">—</span>
          <span className="text-white text-sm hidden md:inline">MERN Stack Developer</span>
        </div>
        ...
        <span className="text-white text-xs">
          © {new Date().getFullYear()} Tanjim Alam. All rights reserved.
        </span>
